        ...
        <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;background-color:#ffffff;border:2px solid #D4A827;border-radius:8px;overflow:hidden;">
          ...
          <tr>
            <td style="padding:40px;">
              ...
              <p style="margin:0 0 24px 0;color:#2C4A2E;font-size:16px;font-family:Georgia,serif;">
                The application information for <strong>${data.contestantFirstName} ${data.contestantLastName}</strong> (${data.divisionName}) has been received and saved.
              </p>
              <p style="margin:0 0 24px 0;color:#2C4A2E;font-size:16px;font-family:Georgia,serif;">
                You do not need to complete the application again. Use the button below to return to your saved application and complete payment.
              </p>
                ...
                <tr>
                  <td style="padding:24px 28px;">
                    ...
                    <table width="100%" cellpadding="0" cellspacing="0">
                      <tr>
                        <td style="padding:5px 0;color:#5C4A32;font-size:14px;font-family:Georgia,serif;">Through October 10</td>
                        <td style="padding:5px 0;color:#2C4A2E;font-size:14px;font-family:Georgia,serif;font-weight:700;text-align:right;">$55.00</td>
                      </tr>
                      <tr>
                        <td style="padding:5px 0;color:#5C4A32;font-size:14px;font-family:Georgia,serif;">October 11–14</td>
                        <td style="padding:5px 0;color:#2C4A2E;font-size:14px;font-family:Georgia,serif;font-weight:700;text-align:right;">$65.00</td>
                      </tr>
                      <tr>
                        <td colspan="2" style="padding-top:12px;border-top:1px solid #D4A827;margin-top:8px;">
              ...
              <p style="margin:0 0 16px 0;color:#5C4A32;font-size:14px;font-family:Georgia,serif;">
                <strong>Keep this email.</strong> The link above is the only way to return to your saved application if you close your browser.
              </p>

              <p style="margin:0 0 24px 0;color:#5C4A32;font-size:14px;font-family:Georgia,serif;">
                Questions? Contact the pageant team at <a href="mailto:wtsfpageant@outlook.com" style="color:#2C4A2E;font-weight:700;">wtsfpageant@outlook.com</a>
              </p>

              <p style="margin:0;color:#5C4A32;font-size:15px;font-family:Georgia,serif;">
                We look forward to welcoming your family!<br /><br />
          ...
          <tr>
            <td style="background-color:#F5EDD4;border-top:1px solid #D4A827;padding:20px 40px;text-align:center;">
              ...
              <p style="margin:0;color:#8B7355;font-size:12px;font-family:Georgia,serif;">Williams Auditorium · Henderson, Tennessee</p>
            </td>
          </tr>
...
The application information for ${data.contestantFirstName} ${data.contestantLastName} (${data.divisionName}) has been received and saved.

IMPORTANT: Registration is not complete until payment is received.

You do not need to complete the application again. Use the link below to return to your saved application and complete payment.

  ${data.resumeUrl}

REGISTRATION FEE
----------------
Through October 10:  $55.00
October 11–14:       $65.00

Registration closes October 14 at 11:59 PM CDT.

Keep this email. The link above is the only way to return to your saved application if you close your browser.
