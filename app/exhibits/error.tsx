...
export default function ExhibitsError({
  error,
  reset,
}: {
  ...
  return (
    ...
    >
      <div className="text-center max-w-md">
        ...
        >
          Couldn&apos;t load exhibits
        </h1>
        <p className="text-sm mb-8" style={{ color: "#5C4A32", lineHeight: 1.7 }}>
          We had trouble loading the exhibit information. Please try again in a
          moment, or contact us at{" "}
