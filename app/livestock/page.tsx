...
import LivestockNav from "@/components/livestock/LivestockNav";
...
function ShowSection({
  ...
  return (
    <section
      ...
      style={{ backgroundColor: bg, scrollMarginTop: "132px" }}
...
export default function LivestockPage() {
  return (
    <>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          >
            ...
            <div className="flex flex-col gap-3 flex-shrink-0 w-full sm:w-auto">
              ...
              <p className="text-xs text-center" style={{ color: "rgba(168,191,169,0.65)" }}>
                Use the show navigation below to jump to a specific show.
              </p>
            </div>
          </div>
        </div>
      ...
      <section id="livestock-schedule" className="py-10" style={{ backgroundColor: "#FDFAF3", borderBottom: "1px solid #E8DFC8" }}>
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <p
