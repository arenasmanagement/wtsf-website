        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 py-16 md:py-20 space-y-20">
          ...
          <section aria-labelledby="gate">
            ...
            <div className="space-y-4 text-sm" style={{ color: "#5C4A32" }}>
              ...
              <p className="text-xs leading-relaxed" style={{ color: "#8B7355" }}>
                Accepted payment methods and other gate details will be confirmed and posted closer
                to the fair.{" "}
                <a
          ...
          <section aria-labelledby="questions">
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                ...
                <a
                  href={FAIR_CONFIG.contact.phoneHref}
                  className="flex items-center gap-2 px-6 py-3 text-sm font-bold tracking-wider uppercase border transition-opacity hover:opacity-80 focus:outline-none focus-visible:ring-2 focus-visible:ring-white"
                  style={{
